...
- Favor direct project-aware help in the real local project.
- Avoid sandbox/setup recommendations unless explicitly requested.
- Do not ask the user to do what Codex can do itself.
...
- Push back when needed; do not perform agreement.
...
- Update this file over time as working preferences become clearer.
